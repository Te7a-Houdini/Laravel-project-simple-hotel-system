...
Route::get('/client/editprofile/{id}' , 'clients\EditProfileController@edit')->name('editprofile.edit')->middleware('auth','forbid-banned-user');
Route::Put('/client/update/{id}' , 'clients\EditProfileController@update')->name('editprofile.update')->middleware('auth','forbid-banned-user');
